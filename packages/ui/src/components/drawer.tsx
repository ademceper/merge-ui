...
const DrawerHeader = React.memo(function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
const DrawerFooter = React.memo(function DrawerFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
